...
const OrderSummary = () => {
    ...
    return (
      <div data-aos="fade-up" className="md:flex p-5 bg-slate-50  rounded-lg">
        {/* Main Content on the Left */}
        <div className=" w-full md:w-2/3 mb-4">
          {/* Display ordered items in a table */}
          <div className="bg-white shadow-md rounded-lg mr-2 ml-2">
            <h2 className="text-xl text-amber-500 font-semibold mb-4 pl-5 pt-4">
              Order Items
            </h2>
              ...
              <table className="w-full border-collapse table-auto pl-5">
                <thead className="bg-amber-50 pl-4">
                  <tr>
                    ...
                    <th className="py-2 pl-1 text-sm font-semibold">
                      Quantity
                    </th>
                    <th className="py-2 pl-2 text-sm font-semibold">
                      Item Price
                    </th>
                      ...
                      <td className="py-2 mr-3">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="text-amber-400 disabled:opacity-30"
                          >
                            <svg
          ...
          <div className="bg-white shadow-md rounded-lg p-4 mr-2 ml-2">
            ...
            <div className="flex justify-between items-center mb-2">
              <span className="text-xs">
                Item's Total (
                <span className="font-semibold">{allItemQuatity}</span>)
              </span>
