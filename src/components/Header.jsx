  ...
  function handleNavigate(result) {
    ...
    return (
        <div className="bg-slate-50 fixed w-full top-0  z-[10000000] py-[0.6rem]">
                ...
                <nav className="flex flex-row justify-between gap-4 items-center  ">
                    ...
                    >
                        <IconButton aria-label="cart">
                            <StyledBadge
                                badgeContent={allCartItems?.length}
                                color="error"
                            >
                                <ShoppingCart />
                            </StyledBadge>
            ...
            <div className="wrap searchbar-double hamburger flex justify-center m-auto w-auto">
                <SearchBar
                    onSearch={(value) => setQuery(value)}
                    onClearSearch={handleClearSearch}
                />
