    ...
    return (
        <div className=''>
            <div className="w-10/12 mx-auto mt-4 bg-slate-200 pt-6 p-4 rounded-t-lg relative">
                <div className="">
                    <h2 className='pb-4 text-3xl mx-auto md:w-fit mb-1'>Best Deals</h2>
                    ...
                    <div className='flex overflow-x-scroll md:grid grid-cols-4  gap-3'>
                        {
                            data.map(item => (
                                <a href={""} key={item.product._id} className='cards bg-white text-black pb-2 px-6 pt-6 rounded relative no-underline'>
                                    <div className='bg-white'>
                                        <small className='text-slate-100 bg-red-500 p-1 absolute top-0 left-0 rounded-tl-sm'>flash</small>
                                        <img src={item.product.images[0]} alt={item.product.name} className='md:w-full h-48 object-contain' />
                                    </div>
                                    <div className=''>
