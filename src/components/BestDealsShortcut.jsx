        ...
        <div className=''>
            <div className="w-10/12 mx-auto mt-4 bg-slate-200 pt-6 p-4 rounded-t-lg relative">
                <div className="">
                    ...
                    <div className='flex overflow-x-scroll  md:grid md:grid-cols-4  gap-3'>
                        {
                            data.map(item => (
                                <div  key={item.product._id} className='bg-white text-black pb-2 px-6 pt-6 rounded relative no-underline'>
