  ...
  return (
    <div className="max-w-xs  mx-auto w-full p-6 mt-10 bg-white rounded shadow-md">
      ...
      <div className="grid grid-cols-2 gap-2 mt-4">
        ...
        <button>
          <Link  className="bg-amber-500 text-white py-2 px-4 rounded mt-4 block mx-auto no-underline hover:underline" to="/checkout/confirmpay">I have completed the transfer</Link>
        </button>
    </div>
  );
}
